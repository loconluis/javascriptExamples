...
console.log(platzom('Programar')); //deberia salir Program
console.log(platzom('Zorro')); //deberia salir Zorrope
console.log(platzom('ArremangalaEmpujeNO')); //deberia de salir Arremangal-aEmpujeNO
console.log(platzom('sometemos')); //deberia de salir SoMeTeMoS
